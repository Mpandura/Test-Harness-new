...
namespace TestHarness
{
  ...
  public class TestHarness : ITestHarness
  {
    ...
    {
      RLog.write("\n  TestHarness received a testRequest - Req #2, Req #3");
    ...
    RequestInfo processRequestAndLoadFiles(Message testRequest)
    {
      ...
      location = System.IO.Path.GetFullPath(localDir_);  // LoadAndTest will use this path
    ...
    bool saveResultsAndLogs(ITestResults testResults)
    {
      ...
      return true;
         ...
         */
        public ServiceHost CreateChannel(string url)//27:00
        {
            WSHttpBinding binding = new WSHttpBinding();
            Uri baseAddress = new Uri(url);
            Type service = typeof(TestHarness);
...
Message testRequest = msg;
    ...
    ILoadAndTest installLoader(AppDomain ad)
    {
      ...
      landt.loadPath(location);  // send file path to LoadAndTest
      return landt;
    }
#if (TEST_TESTHARNESS)
